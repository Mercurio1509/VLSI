...
Con este valor podemos calcular la constante RC, para NMOS $\tau=24.48E-12 s$, para PMOS $\tau=71.4E-12 s$. A continuación se le muestra una tabla resumen con los resultados.
